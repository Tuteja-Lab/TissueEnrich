...
teEnrichmentCustom<-function(inputGenes=NULL,
                             ...
                             multiHypoCorrection = TRUE)
{
  ...
  inputGenes <- ensurer::ensure_that(inputGenes, !is.null(.) &&
                                     (class(.) == "GeneSet") &&
                                     !is.null(geneIds(.)),err_desc =
                                     "Please enter correct inputGenes.
                                        It should be a Gene set object.")
  ##Check for dataset class, rows and should not be NULL
  tissueSpecificGenes <- ensurer::ensure_that(tissueSpecificGenes, !is.null(.)
  ...
  tissueSpecificGenes <- ensurer::ensure_that(tissueSpecificGenes,!is.null(.)
                                            ...
                                            tissueSpecificGenes. It should be
  ...
  for(tissue in tissueNames)
  {
    ...
    pValue<-stats::phyper(overlapGenes-1,
                          GenesInTissue,
