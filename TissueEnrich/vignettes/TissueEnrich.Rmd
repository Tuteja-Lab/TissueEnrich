...
The first object in the `output` list is a dataframe containing the $-Log_{10}(P-Value)$ along with the number of tissue-specific genes in the input gene set. This dataframe object can be used to visualize tissue-specific gene enrichment in the form of a histogram.
